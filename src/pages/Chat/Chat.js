...
const Chat = props => {
    ...
    document.title=" Chat | Pendien - Responsive Bootstrap 5 Admin Dashboard"
    ...
    return (
        <React.Fragment>
            <div className="page-content">
                <Container fluid>
                    {/* Render Breadcrumb */}
                    <Breadcrumbs title="Pendien" breadcrumbItem="Chat" />
                                ...
                                <div className="d-flex align-items-start">
                                    ...
                                    <div className="flex-grow-1">
                                        <h5 className="font-size-16 mt-0 mb-1">
                                            <Link to="#" className="text-reset">{currentUser.name} <i className="mdi mdi-circle text-success align-middle font-size-10 ms-1"></i></Link>
                                        </h5>
                                                        ...
                                                        >
                                                            <div className="d-flex align-items-start">
                                                                ...
                                                                <div className="flex-grow-1 overflow-hidden">
                                                                    ...
                                                                    <p className="text-truncate mb-0 text-body">
                                                                        {chat.description}
                                                                    </p>
                                                                </div>
                                                            ...
                                                            <div className="ctext-wrap">
                                                                <div className="ctext-wrap-content">
                                                                    <h5 className="font-size-14 conversation-name">
                                                                        <Link to="#" className="text-reset">{message.sender}</Link>
