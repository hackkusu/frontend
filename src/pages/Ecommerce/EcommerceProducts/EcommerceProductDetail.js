...
import { productColorData } from "../../../common/data/ecommerce";
                    ...
                    <Row>
                      ...
                      <Col xl={7}>
                        <div className="mt-4 mt-xl-3 ps-xl-4">
                          ...
                          <h5 className="mt-4 pt-2"><del className="text-muted me-2">${product.oldPrice}</del>${product.newPrice}
                            <span className="text-danger font-size-14 ms-2">- 20 % Off
                            </span>
                          </h5>
                            ...
                            <Col lg={7} sm={8}>
                              <div className="product-desc-color mt-3">
                                ...
                                <ul className="list-inline">
                                  {productColorData.map((item, idx) => (
                                    <React.Fragment key={idx}>
                                      <li className="list-inline-item">
                                        <Link to="#" className={(idx === 0) ? 'active' : ''} data-bs-toggle="tooltip" id={item.color}>
                                          <div className="product-color-item">
                                            <img src={item.img} alt="" className="avatar-md" />
                                          </div>
                                        </Link>
                                      </li>
                                      <UncontrolledTooltip                                                                            
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(withRouter(EcommerceProductDetail))
