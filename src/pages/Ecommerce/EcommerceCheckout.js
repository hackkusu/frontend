...
const EcommerceCheckout = () => {
  ...
  document.title=" Checkout | Pendien - Responsive Bootstrap 5 Admin Dashboard"
            ...
            <Row className="mb-3">
              <Col xl={8}>
                <div className="custom-accordion">
                  <Card>
                    <Link onClick={toggle} className="text-reset" to="#">
                      <div className="p-4">
                  ...
                  <Card>
                    <Link onClick={togglePaymentinfo} className="collapsed text-reset" to="#">
                      <div className="p-4">
